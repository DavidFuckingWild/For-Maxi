/*
    ...
    Why?
    Because functions have (unlike in other programming languages) a this-keyword and a __prototype__.
    What they are, how and when to use them will I explain later. 
...
// you want not do that by an assigment.
